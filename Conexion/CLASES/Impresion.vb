...
Public Class Impresion
    ...
    Public Sub New(ByRef Xspread As FarPoint.Win.Spread.FpSpread, ByVal sDirec As String(), ByVal sNomin As String, ByVal sNombr As String, ByVal sTot As String, Optional ByVal Xtipo As Integer = 0)
        sDireccion = sDirec
        spread = Xspread
        tipo = Xtipo
        sNomina = sNomin
    ...
    Public Sub New(ByRef reng As Collection)
    ...
    Public Sub imprime(ByVal AbreCajon As Boolean)
        ...
        If System.IO.File.Exists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\ticket.txt") Then
            Dim TxtPath As String
            TxtPath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\ticket.txt"
            Using sw As New StreamWriter(TxtPath, False)
            ...
            fileToPrint = New System.IO.StreamReader(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) & "\ticket.txt")
            ...
            If AbreCajon Then
                ...
                If Not RawPrinterHelper.SendStringToPrinter(PrSet.PrinterName, drawerCommand) Then
                    MsgBox("No pudo abrirse el cajón.", vbCritical, "Error")
                End If
            End If
            ...
            ''End With
        Else
            MsgBox("Agregue archivo de Ticket en Documentos. Reimprima Ticket en módulo.", vbInformation, "Punto de Venta")
        End If

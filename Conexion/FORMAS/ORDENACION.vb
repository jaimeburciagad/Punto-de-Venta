...
Public Class ORDENACION
    ...
    Private Sub RELLENACONF()
        ...
        If dsc.Tables("conf").Rows.Count > 0 Then
            ...
            For i = 0 To dsc.Tables("conf").Rows.Count - 1
                ...
                fp_conf.ActiveSheet.Cells(i, 0).Value = dsc.Tables("conf").Rows(i)("conf_orden")
    ...
    Private Sub LBL_GUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LBL_GUARDAR.Click
        ...
        Base.Ejecuta("update ecconfiguracion set conf_orden=0 WHERE conf_id='" & CONCEPTO & "'", xCon)
        For i = 0 To fp_conf.ActiveSheet.RowCount - 1
            If CDbl(fp_conf.ActiveSheet.Cells(i, 0).Text) <> 0 Then
                sql = "Update ecconfiguracion set conf_orden=" & fp_conf.ActiveSheet.Cells(i, 0).Value & _
        ...
        MsgBox("Configuración de Orden Guardada", MsgBoxStyle.Exclamation)
    ...
    Private Sub lbl_tachasalir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lbl_tachasalir.Click
        LBL_SALIR_Click(sender, e)
    End Sub

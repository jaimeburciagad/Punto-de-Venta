...
#End Region
    ...
    Private Sub FrVenta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            Debug.Print("No se pudo iniciar monitoreo de cajón: " & ex.Message)
        End Try
 ...
 "','" & txe.Text.Trim & "')"
    ...
    Private Sub FormateaSpread()
        ...
        ColFormatting1.Add(New DiseñaSpread(Name:="FactorFactura", ColHeaderRows:=2, ColHeaderCols:=1, ColWidth:=100, RowIndex:=0, ColIndex:=20, ColAlign:=CellHorizontalAlignment.Right, ColType:=DiseñaSpread.NumeroConDecimal, ColVisible:=False, ColLocked:=True))
    ...
    Private Sub Cajon_Error(mensaje As String)
        ...
        Debug.Print("Error cajón: " & mensaje)
    ...
    Private Sub MostrarBannerCajonError(mensaje As String)
        ...
        lblBannerCajonTitulo.Text = "MONITOR DE CAJÓN NO DISPONIBLE"
    ...
    Private Sub MostrarBannerCajon(abierto As Boolean,
        ...
        If origenTexto.ToUpper().Contains("MANUAL") OrElse origenTexto.ToUpper().Contains("LLAVE") Then
            ...
            lblBannerCajonTitulo.Text = "⚠ CAJÓN ABIERTO MANUALMENTE"
        ...
        ElseIf segundosAbierto >= 20 Then
            ...
            lblBannerCajonTitulo.Text = "⚠ CAJÓN ABIERTO DEMASIADO TIEMPO"
        ...
        Else
            ...
            lblBannerCajonTitulo.Text = "CAJÓN ABIERTO"
            lblBannerCajonDetalle.Text = segundosAbierto.ToString() & " segundos abierto - " & origenTexto
        End If
